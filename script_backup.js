...
function showProductDetails(productId) {
    ...
    const images = [product.image, product.image, product.image]; // Simulando múltiplas imagens
        ...
        <div style="margin-top: 4rem;">
            ...
            <div class="recent-grid">
                <div class="recent-card" onclick="showProductDetails(2)">
                    <img src="images/calca-baggy.webp" alt="Calça Baggy" class="product-image">
                    <div class="product-info">
                ...
                <div class="recent-card" onclick="showProductDetails(4)">
                    <img src="images/shorts-nike.webp" alt="Shorts Nike" class="product-image">
                    <div class="product-info">
